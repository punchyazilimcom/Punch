<?php
/**
 * Lucide tarzi ince cizgi ikon seti. Kullanim:
 *   <?= $__view->partial('partials/icon', ['name' => 'arrow-right']) ?>
 */
$name = $name ?? 'circle';
$icons = [
...
$size = $size ?? 24;
?>
<svg class="icon" width="<?= (int)$size ?>" height="<?= (int)$size ?>" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><?= $path ?></svg>
